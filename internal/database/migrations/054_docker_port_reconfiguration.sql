ALTER TABLE system_update_jobs
  ADD COLUMN IF NOT EXISTS docker_published_host_ip VARCHAR(45) NULL,
  ADD COLUMN IF NOT EXISTS docker_old_published_port INT UNSIGNED NULL,
  ADD COLUMN IF NOT EXISTS docker_new_published_port INT UNSIGNED NULL,
  ADD COLUMN IF NOT EXISTS docker_old_container_port INT UNSIGNED NULL,
  ADD COLUMN IF NOT EXISTS docker_new_container_port INT UNSIGNED NULL,
  ADD COLUMN IF NOT EXISTS docker_old_health_port INT UNSIGNED NULL,
  ADD COLUMN IF NOT EXISTS docker_new_health_port INT UNSIGNED NULL,
  ADD COLUMN IF NOT EXISTS docker_approved_compose_config_sha256 CHAR(64) NULL,
  ADD COLUMN IF NOT EXISTS docker_approved_compose_revision BIGINT NULL,
  ADD COLUMN IF NOT EXISTS docker_expected_version_env_sha256 CHAR(71) NULL,
  ADD COLUMN IF NOT EXISTS docker_expected_container_id VARCHAR(64) NULL,
  ADD COLUMN IF NOT EXISTS docker_expected_image_id CHAR(71) NULL,
  ADD COLUMN IF NOT EXISTS docker_expected_repository_digest CHAR(71) NULL;
