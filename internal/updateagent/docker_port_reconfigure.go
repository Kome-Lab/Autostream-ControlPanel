...
func (o dockerPortObservation) validate() error {
	if o.MappingEnv.validate() != nil ||
		...
		!remotePlanHashPattern.MatchString(o.ComposePolicySHA256) ||
		!remotePlanHashPattern.MatchString(o.ComposeConfigSHA256) ||
...
func (m dockerPortPreparedModel) validate() error {
	if !remotePlanHashPattern.MatchString(m.ComposePolicySHA256) ||
		!remotePlanHashPattern.MatchString(m.ComposeConfigSHA256) ||
...
func (l dockerPortLedger) validate(targetID string) error {
	if l.SchemaVersion != 1 ||
		...
		!remotePlanHashPattern.MatchString(l.OldComposeSHA256) ||
		!remotePlanHashPattern.MatchString(l.TargetComposeSHA256) {
...
func (a dockerPortAppliedState) validate(targetID string) error {
	if a.SchemaVersion != 1 ||
		...
		!remotePlanHashPattern.MatchString(a.ComposeConfigSHA256) ||
...
type dockerPortRuntime interface {
	...
	ConsumeGrant(context.Context, SystemdPortReconfigurePlan, string, string, RemoteSecret) error
...
func handleLocalExecutorDockerPortMutation(
	...
	policy LocalExecutorPolicy,
	request LocalExecutorRequest,
	remoteRuntime remoteHelperRuntime,
) LocalExecutorResponse {
