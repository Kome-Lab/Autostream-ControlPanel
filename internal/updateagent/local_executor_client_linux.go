...
func (c LocalExecutorClient) Stage(ctx context.Context, plan RemotePlan, fence LocalExecutorMutationFence) (RemoteStageResult, error) {
	...
	if response.Stage == nil ||
		...
		return RemoteStageResult{}, errors.New("local executor stage response does not match the immutable plan")
	}
	return *response.Stage, nil
}

func (c LocalExecutorClient) Apply(ctx context.Context, plan RemotePlan, fence LocalExecutorMutationFence, grant RemoteSecret) (ApplyResult, error) {
	return c.executeMutationResult(ctx, "apply", plan, fence, grant)
}

func (c LocalExecutorClient) Reconcile(ctx context.Context, plan RemotePlan, fence LocalExecutorMutationFence, grant RemoteSecret) (ApplyResult, error) {
...
func (c LocalExecutorClient) executeMutationResult(ctx context.Context, operation string, plan RemotePlan, fence LocalExecutorMutationFence, grant RemoteSecret) (ApplyResult, error) {
...
func (c LocalExecutorClient) executeMutation(ctx context.Context, operation string, plan RemotePlan, fence LocalExecutorMutationFence, grant RemoteSecret) (LocalExecutorResponse, error) {
