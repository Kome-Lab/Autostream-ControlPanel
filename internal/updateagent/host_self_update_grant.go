...
// Plane grant. The raw token is deliberately held separately in RemoteSecret.
...
func (b HostSelfUpdateGrantBinding) validate(expectConsumed bool) error {
	...
	if !digestPattern.MatchString(b.ExpectedLocalExecutorPolicySHA256) ||
		...
		!updateHostBootstrapCommitPattern.MatchString(b.ReleaseCommit) ||
	...
	if b.DirectiveIssuedAt.IsZero() ||
		...
		!remotePlanHashPattern.MatchString(b.PlanSHA256) ||
		b.Revision < 1 ||
		b.IssuedAt.IsZero() ||
