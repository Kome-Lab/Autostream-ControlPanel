...
type LocalExecutorMutationClient interface {
	Stage(context.Context, RemotePlan, LocalExecutorMutationFence) (RemoteStageResult, error)
	Apply(context.Context, RemotePlan, LocalExecutorMutationFence, RemoteSecret) (ApplyResult, error)
	Reconcile(context.Context, RemotePlan, LocalExecutorMutationFence, RemoteSecret) (ApplyResult, error)
}

type LocalExecutorPortMutationClient interface {
	PortReconfigure(context.Context, SystemdPortReconfigurePlan, LocalExecutorMutationFence, RemoteSecret) (SystemdPortReconfigureResult, error)
	PortReconfigureReconcile(context.Context, SystemdPortReconfigurePlan, LocalExecutorMutationFence, RemoteSecret) (SystemdPortReconfigureResult, error)
}
...
type LocalExecutorRuntimeCredentialClient interface {
	...
	StageRuntimeCredential(context.Context, HostAgentRuntimeTokenRotation, RemoteSecret) (RuntimeCredentialStatus, error)
