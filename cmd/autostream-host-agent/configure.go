...
func defaultHostAgentConfigureDependencies() hostAgentConfigureDependencies {
	return hostAgentConfigureDependencies{
		...
		ServiceIdentity: func() (updateagent.HostAgentConfigurePeerIdentity, error) {
			return updateagent.LookupManagedServiceIdentity(
				hostAgentInstallGroup,
				hostAgentInstallGroup,
			)
		},
		ReadToken: defaultReadHostAgentConfigureToken,
		Stage: func(ctx context.Context, panelURL, nodeID, token string, peer updateagent.HostAgentConfigurePeerIdentity, timeout time.Duration) (updateagent.UpdaterStagedConfiguration, error) {
			return updateagent.StageHostAgentConfiguration(
				ctx,
				http.DefaultClient,
				panelURL,
				nodeID,
		...
		ValidateInstalled: updateagent.ValidateInstalledHostAgentConfiguration,
...
func validateHostAgentStagedConfiguration(staged updateagent.UpdaterStagedConfiguration) error {
	...
	if staged.Config.API != (updateagent.APIConfig{}) {
