...
test("AST dependency guard includes B-02 and reports zero production consumers", () => {
  assert.deepEqual(assertUIFoundationContractBoundaries(webRoot), { fileCount: 7 });
});
