...
export function TopBar(props: TopBarProps) {
  return (
    <header className="sticky top-0 z-20 flex min-h-[4.5rem] items-center justify-between gap-2 border-b bg-background px-3 sm:gap-3 sm:px-4 md:px-5 xl:px-6">
      <div className="flex min-w-0 items-center gap-3">
        {props.mobileNavigation}
        <div className="min-w-0">
          <div className="text-xs font-semibold text-primary">{props.pageSection}</div>
