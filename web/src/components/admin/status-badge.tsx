...
const statusMap: Record<string, { label: string; detail: string; className: string }> = {
  ...
  ready: { label: "待機中", detail: "自動開始待ち", className: "border-teal-200 bg-teal-50 text-teal-700" },
  created: { label: "待機枠", detail: "設定済みの配信枠", className: "border-blue-200 bg-blue-50 text-blue-700" },
