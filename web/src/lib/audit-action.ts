const auditActionLabels: Record<string, string> = {
  ...
  "system_updates.updater_policy.save": "中央Updater設定を保存",
  "system_updates.bootstrap.create": "ホストhelperのセットアップを開始",
  "system_updates.bootstrap.claim": "ホストhelperのセットアップジョブを取得",
  "system_updates.bootstrap.accept": "ホストhelperの認証情報を受領",
  "system_updates.bootstrap.report": "ホストhelperのセットアップ進捗を報告",
  "system_updates.bootstrap.succeeded": "ホストhelperのセットアップに成功",
  "system_updates.bootstrap.failed": "ホストhelperのセットアップに失敗",
