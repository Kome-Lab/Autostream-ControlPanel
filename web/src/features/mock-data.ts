...
const mockResourceData: Record<string, unknown[]> = {
  ...
  "/integrations/oauth-accounts": [
    { id: "acct-drive", provider_id: "google-main", provider_type: "google", provider_name: "Google Workspace", account_label: "広報 Drive", display_name: "広報 Drive", email: "archive@example.jp", account_purpose: "drive", scopes: ["openid", "email", "https://www.googleapis.com/auth/drive.file"], status: "connected", refresh_token_configured: true, refresh_token_updated_at: baseTime, updated_at: baseTime },
    { id: "acct-youtube", provider_id: "google-main", provider_type: "google", provider_name: "Google Workspace", account_label: "YouTube 管理", display_name: "YouTube 管理", email: "live@example.jp", account_purpose: "youtube", scopes: ["openid", "email", "https://www.googleapis.com/auth/youtube.force-ssl"], status: "connected", refresh_token_configured: true, refresh_token_updated_at: "2026-07-01T16:10:00+09:00", updated_at: "2026-07-01T16:10:00+09:00" },
    { id: "acct-both", provider_id: "google-main", provider_type: "google", provider_name: "Google Workspace", account_label: "配信運用 共通", display_name: "配信運用 共通", email: "operations@example.jp", account_purpose: "drive_youtube", scopes: ["openid", "email", "https://www.googleapis.com/auth/drive.file", "https://www.googleapis.com/auth/youtube.force-ssl"], status: "connected", refresh_token_configured: true, refresh_token_updated_at: "2026-07-02T09:30:00+09:00", updated_at: "2026-07-02T09:30:00+09:00" },
  ],
  "/users": [
